...
public interface BookingService {
    ...
    Collection<BookingResponseDTO> getUserBookings(Integer userId, String state);
    Collection<BookingResponseDTO> getUserItemsBookings(Integer userId, String state);
}
